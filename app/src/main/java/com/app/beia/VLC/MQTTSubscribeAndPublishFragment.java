...
public class MQTTSubscribeAndPublishFragment extends Fragment {

    public String                       topicToSubscribe = "vlc/date";
    ...
    public Button                       fabSubscribeTotopic;
    public Button                       fabConnect;
    public FloatingActionButton fabLaunchPublish;

    public Button                       fabPublicareB;

    public Switch                       swTemp;
    public Switch                       swLumina;
    public Switch                       swMiscare;
    public Switch                       swPraf;
    public Switch                       swSunet;

    public GridView                     listViewMessages;

    public SubscribeDataPassListener    mCallback;
    public PublishDataPassListener pCallback;

    public MQTTSubscribeAndPublishFragment() {
    ...
    public interface SubscribeDataPassListener {
        void launchPublishFragment(String messageParams[]);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof Activity){
            ...
            try {
                pCallback = (PublishDataPassListener) activity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fabSubscribeTotopic = (Button) rootView.findViewById(R.id.fabSubscribeToTopic);
        fabConnect          = (Button) rootView.findViewById(R.id.fabConnect);
        fabPublicareB  = (Button) rootView.findViewById(R.id.fabPublicare);

        topicSubscribe      = (EditText)             rootView.findViewById(R.id.editTextSubscribeTopic);

        swTemp = (Switch) rootView.findViewById(R.id.swTemp);
        swLumina = (Switch) rootView.findViewById(R.id.swLumina);
        swMiscare = (Switch) rootView.findViewById(R.id.swMiscare);
        swPraf = (Switch) rootView.findViewById(R.id.swPraf);
        swSunet = (Switch) rootView.findViewById(R.id.swSunet);

        fabSubscribeTotopic .setOnClickListener(onClickListenerMQTT);
        fabConnect          .setOnClickListener(onClickListenerMQTT);
        fabPublicareB  .setOnClickListener(onClickListenerMQTT);
        ...
        listViewMessages = (GridView) rootView.findViewById(R.id.listViewMessages);
    ...
    private View.OnClickListener onClickListenerMQTT = new View.OnClickListener() {
        ...
        public void onClick(final View v) {
            ...
            switch(v.getId()){
                ...
                case R.id.fabPublicare:
                    textToPublish = "";
                    topicToPublish = "vlc/parametri";
                    qos = "0";

                    if (swTemp.isChecked())
                        textToPublish = textToPublish + "temperatura ";
                    if (swLumina.isChecked())
                        textToPublish = textToPublish + "lumina ";
                    if (swMiscare.isChecked())
                        textToPublish = textToPublish + "miscare ";
                    if (swPraf.isChecked())
                        textToPublish = textToPublish + "praf ";
                    if (swSunet.isChecked())
                        textToPublish = textToPublish + "sunet ";

                    // Bundle the parameters, and call the parent Activity method to start the connection
                    String connectParams2[] = {"publish", textToPublish,topicToPublish,qos};
                    pCallback.publishMQTTmessage(connectParams2);
